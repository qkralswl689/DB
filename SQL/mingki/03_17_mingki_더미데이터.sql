...
IS  
      ...
      temp_num NUMBER(2);  
BEGIN  
      first_names := first_name_array('김','이','박','최','주','임','엄','성','배','독고','황','황보','송','오','유','류','윤','장','정','추');  
      middle_names := middle_name_array('미','호','영','현','선','원','우','이','운','성');  
      ...
      FOR i IN 1..100 LOOP  
        ...
        UPDATE studyjdbc SET member_name = totalName  
